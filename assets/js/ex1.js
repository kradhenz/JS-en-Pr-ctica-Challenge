function validation(name, subject, msg) {
    let success = true;
    let validate = /[a-zA-Z]/gim;

    if (validate.test(name) == false) {
        document.querySelector(".nameError").innerHTML = "Ingrese un nombre válido."
        success = false;
    };

    if (validate.test(subject) == false) {
        document.querySelector(".subjectError").innerHTML = "Ingrese un nombre válido."
        success = false;
    };

    if (validate.test(msg) == false) {
        document.querySelector(".msgError").innerHTML = "Ingrese un nombre válido."
        success = false;
    };
